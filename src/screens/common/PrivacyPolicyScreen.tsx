...
export default function PrivacyPolicyScreen() {
  ...
  return (
    ...
    >
      <Header title="개인정보처리방침" onBack={() => router.back()} />
      ...
      <main className={styles.page}>
        <article className={styles.document}>
          ...
          <section className={styles.section}>
            ...
            <p>
              학번은 다른 참여자에게 공개되지 않으며, 본인만 확인할 수
              있습니다.
            </p>
            <p>
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              없습니다. 모임 참여 기록과 프로필은 함께 참여한 다른 이용자의
              모임 기록과 연결되어 있어 곧바로 삭제되지 않습니다. 완전 삭제를
              원하시면 아래 문의처로 요청해 주세요.
            </p>
            <p>
              로그인 유지용 토큰은 발급 후 14일 이내 만료되며, 로그아웃 시
              즉시 삭제됩니다. 이 토큰은 로그인 상태 유지를 위해 쿠키에
              저장되며, 브라우저에서 쿠키를 차단하면 로그인이 정상적으로
              동작하지 않을 수 있습니다.
            </p>
          </section>
